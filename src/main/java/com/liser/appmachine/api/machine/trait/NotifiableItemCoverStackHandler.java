...
public class NotifiableItemCoverStackHandler extends NotifiableCoverRecipeHandlerTrait<Ingredient>
        implements ICapabilityTrait, IItemHandlerModifiable, IEnhancedManaged {

    public static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(NotifiableItemCoverStackHandler.class);
    @Getter
    ...
    public NotifiableItemCoverStackHandler(CoverDefinition definition, ICoverable coverHolder, Direction attachedSide, int slots, @NotNull IO handlerIO, @NotNull IO capabilityIO,
    ...
    public NotifiableItemCoverStackHandler(CoverDefinition definition, ICoverable coverHolder, Direction attachedSide, int slots, @NotNull IO handlerIO, @NotNull IO capabilityIO) {
        this(definition, coverHolder, attachedSide, slots, handlerIO, capabilityIO, CustomItemStackHandler::new);
    }

    public NotifiableItemCoverStackHandler(CoverDefinition definition, ICoverable coverHolder, Direction attachedSide, int slots, @NotNull IO handlerIO) {
        this(definition, coverHolder, attachedSide, slots, handlerIO, handlerIO);
    }

    public NotifiableItemCoverStackHandler setFilter(Predicate<ItemStack> filter) {
