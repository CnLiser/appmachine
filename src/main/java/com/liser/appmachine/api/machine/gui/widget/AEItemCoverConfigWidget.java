...
public class AEItemCoverConfigWidget extends ConfigWidget {

    private final ExportOnlyCoverAEItemList itemList;

    public AEItemCoverConfigWidget(int x, int y, ExportOnlyCoverAEItemList list) {
